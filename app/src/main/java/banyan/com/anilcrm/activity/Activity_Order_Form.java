...
public class Activity_Order_Form extends AppCompatActivity {
        ...
        btn_add_to_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str_Shop_id == null) {
                    ...
                    Float flot_total = flot_qty * flot_price;
                    ...
                    MyListAdapter adapter = new MyListAdapter(Activity_Order_Form.this, R.layout.my_custom_list, heroList);
    ...
    public void Get_VALUE() {
        ...
        for (int j = 0; j < Arraylist_id.size(); j++) {
            ...
            String final_order = str_final_id + "-" + str_final_groupid + "-" + str_final_qty + "-" + str_final_price;
