...
import banyan.com.anilcrm.activity.Tab_MySchedulee;
...
public class MyTask_Adapter extends BaseAdapter {
    ...
    public long getItemId(int position) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            title.setText(result.get(Tab_MySchedulee.TAG_TASK_TITLE));
            date.setText(result.get(Tab_MySchedulee.TAG_TASK_DATE));
