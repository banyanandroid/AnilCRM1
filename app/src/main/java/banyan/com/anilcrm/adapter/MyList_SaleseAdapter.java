...
import banyan.com.anilcrm.activity.Activity_Sales_Return_Form;
...
public class MyList_SaleseAdapter extends ArrayAdapter<Hero> {
    ...
    public MyList_SaleseAdapter(Context context, int resource, List<Hero> heroList) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                removeHero(position);
                Activity_Sales_Return_Form.Fun_Total_Cal();
            }
        });
