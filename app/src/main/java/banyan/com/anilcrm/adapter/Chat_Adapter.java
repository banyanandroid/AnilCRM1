...
import banyan.com.anilcrm.activity.Tab_MyTask;
...
public class Chat_Adapter extends BaseAdapter {
    ...
    public Chat_Adapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public long getItemId(int position) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            title.setText(result.get(Tab_MyTask.TAG_SCHEDULE_TITLE));
            date.setText(result.get(Tab_MyTask.TAG_SCHEDULE_DATE));
